...
public class WorldResource {
	...
	public Response addCountry( @Context SecurityContext sc,
		...
		if (role) {
			Country country = service.addCountry(code, iso3, name, continent, region, surface, indepyear, population,
												lifeexpectancy, gnp, gnpoid, localname, governmentform, headofstate,
	...
	public String getGrootsteLanden() {
		WorldService service = ServiceProvider.getWorldService();
		JsonArray countryArray = buildJsonCountryArray(service.find10LargestSurfaces());
